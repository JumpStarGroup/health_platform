...
1.  **Analysis**:
   ...
   - Only run this workflow for `complexity:complex` requirements. Simple requirements do not require a design document and must proceed to Development_Readiness_Reviewer after requirement approval.
...
- `complexity:simple` requirements do not require an architecture document on a docs branch.
...
- If architecture changes the requirement scope, hand back to Product_Manager and Requirement_Reviewer before planning.
